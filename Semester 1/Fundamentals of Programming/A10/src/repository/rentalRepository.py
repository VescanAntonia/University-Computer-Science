...
import operator
from src.repository.utilities import IterableData
import pickle
import json


class RentalRepository:
    def __init__(self, list_of_rental=None):
        if list_of_rental is None:
            list_of_rental = []
        if list_of_rental is IterableData:
            self._list_of_rental = list_of_rental
        else:
            self._list_of_rental = IterableData(list_of_rental)
    ...
    def remove(self, rental_id):
        ...
        self._list_of_rental.remove(does_id_rental_exists)
