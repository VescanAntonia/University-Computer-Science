...
class MovieRepository:
    ...
    def remove_movie(self, movie_Id):
        ...
        self.list_of_movie.pop(position)
    ...
    def display_movies(self):
        """
        :return: the string with the movies to be displayed
        """
    ...
    def update_movie(self, movie_id, users_given_movie_title, users_given_movie_description, users_given_movie_genre):
        ...
        self.list_of_movie[position].set_title(new_movie.get_title)
        self.list_of_movie[position].set_description(new_movie.get_description)
        self.list_of_movie[position].set_genre(new_movie.get_genre)
    ...
    def search_the_given_title_in_movies_list(self, given_word_to_search_for_title):
        ...
        :return: the string containing all the movies which title match with the given word
        """
        list_found_movies_based_on_title = ''
        for movie_for_search_title in self.list_of_movie:
    ...
    def search_the_given_description_in_movies_list(self, given_word_to_search_for_description):
        ...
        :return: the string containing all the movies which description match with the given word
        """
        list_found_movies_based_on_description = ''
        for movie_for_search_description in self.list_of_movie:
    ...
    def search_for_the_given_genre_movies_list(self, given_word_to_search_for_genre):
        ...
        :return: the string containing all the movies which genre match with the given word
        """
        list_found_movies_based_on_genre = ''
        for movie_for_search_genre in self.list_of_movie:
    ...
    def determine_the_list_for_the_most_rented_movies(self, list_of_the_sorted_rented_days):
        """
        :param list_of_the_sorted_rented_days: a list containing the id of the movies and the corresponding number of rented days
        :return: a string containing the most rented movies
        """
        ...
        for element in new_list_with_the_keys_movies_id:
            ...
            movies_sorted_list_rented_days += self.list_of_movie[movie_index_in_list].printMovie()
    ...
    def generate_the_movies(self):
        """
        :return: generates randomly the list of the movies
        """
        n = 20
        for i in range(n):
    ...
    def get_the_data_for_movie_updated_to_undo(self, movie_given_id):
        ...
        current_movie = self.list_of_movie[movie_position_in_list]
...
# def add_movie_returns_true():
#     function = MovieRepository()
#     function.add_new_movie('1', 'Frozen (2013)', "A", "b")
#
#
# add_movie_returns_true()
#
#
# def add_movie_throws_id_must_be_a_number():
#     function = MovieRepository()
#     try:
#         function.add_new_movie('m', 'Frozen (2013)', "A", "b")
#         assert False
#     except RepositoryException as re:
#         assert(str(re))
#
#
# add_movie_throws_id_must_be_a_number()
#
#
# def add_movie_throws_id_must_be_a_positive_number():
#     function = MovieRepository()
#     try:
#         function.add_new_movie('-1', 'Frozen (2013)', "A", "b")
#         assert False
...
#
#
# add_movie_throws_id_must_be_a_positive_number()
#
#
# def add_movie_throws_title_cannot_be_a_number():
#     function = MovieRepository()
#     try:
#         function.add_new_movie('m', '4', "A", "b")
#         assert False
#     except RepositoryException as re:
#         assert(str(re))
#
#
# add_movie_throws_title_cannot_be_a_number()
#
#
# def add_movie_throws_description_cannot_be_a_number():
#     function = MovieRepository()
#     try:
#         function.add_new_movie('m', 'n', "4", "b")
#         assert False
#     except RepositoryException as re:
#         assert(str(re))
#
#
# add_movie_throws_description_cannot_be_a_number()
#
#
# def add_movie_throws_genre_cannot_be_a_number():
#     function = MovieRepository()
#     try:
#         function.add_new_movie('m', 'm', "A", "4")
#         assert False
#     except RepositoryException as re:
#         assert(str(re))
#
#
# add_movie_throws_genre_cannot_be_a_number()
#
#
# def remove_movie_is_true():
#     function = MovieRepository()
#     function.add_new_movie("4", "m", "n", "o")
#     function.remove_movie(4)
#
#
# remove_movie_is_true()
#
#
# def remove_movie_throws_id_does_not_exist():
#     function = MovieRepository()
#     try:
#         function.remove_movie(4)
#         assert False
...
#
#
# remove_movie_throws_id_does_not_exist()
#
#
# def find_movie_returns_true():
#     function= MovieRepository()
#     function.add_new_movie(5, "m", "c", "d")
#     assert function.find_movie_in_movies_list(5) != -1
#
#
# find_movie_returns_true()
#
#
# def find_movie_returns_false():
#     function = MovieRepository()
#     assert function.find_movie_in_movies_list(111) == -1
#
#
# find_movie_returns_false()
#
#
# def update_the_movies_throws_title_cannot_be_a_number():
#     function = MovieRepository()
#     try:
#         function.update_movie("4", "4", "m", "m")
#         assert False
#     except RepositoryException as re:
#         assert str(re)
#
#
# update_the_movies_throws_title_cannot_be_a_number()
#
#
# def update_the_movies_throws_description_cannot_be_a_number():
#     function = MovieRepository()
#     try:
#         function.update_movie("4", "m", "4", "m")
#         assert False
#     except RepositoryException as re:
#         assert str(re)
#
#
# update_the_movies_throws_description_cannot_be_a_number()
#
#
# def update_the_movies_throws_genre_cannot_be_a_number():
#     function = MovieRepository()
#     try:
#         function.update_movie("4", "m", "m", "5")
#         assert False
#     except RepositoryException as re:
#         assert str(re)
#
#
# update_the_movies_throws_genre_cannot_be_a_number()
#
#
# def update_the_movies_throws_id_cannot_be_a_negative_number():
#     function = MovieRepository()
#     try:
#         function.update_movie("-4", "m", "m", "m")
#         assert False
#     except RepositoryException as re:
#         assert str(re)
#
#
# update_the_movies_throws_id_cannot_be_a_negative_number()
