...
#class CarTextFileRepo(car_repo):
 #   pass


# class ClientTextFileRepo(client_repo):
#     def __init__(self, person_id, given_name):
...
#
#     def __str__(self):
#         return str(self._personId) + " " + self._givenName
...
#class RentalTextFileRepo(rental_repo):
 #   pass
