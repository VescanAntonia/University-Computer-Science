...
class FileTextClientRepository(ClientRepository):
    ...
    def _read_all_from_file(self):
        with open(self.__file_path, 'r') as reading_from_file:
    ...
    def __write_all_to_file(self):
        with open(self.__file_path, 'w') as writing_to_file:
            for client in self._list_of_clients:
                writing_to_file.write(self.__write_function(client) + '\n')
...
class FileBinaryClientRepository(ClientRepository):
    ...
    def __read_all_from_file(self):
        with open(self.__file_path, 'rb') as read_from_file:
            self._list_of_clients.clear()
            try:
                self._list_of_clients = pickle.load(read_from_file)
            except EOFError:
                pass

    def __write_all_to_file(self):
        with open(self.__file_path, 'wb') as write_to_file:
            pickle.dump(self._list_of_clients, write_to_file)

    def __append_to_file(self, client):
        with open(self.__file_path, 'wb') as append_to_file:
            pickle.dump(self._list_of_clients, append_to_file)
