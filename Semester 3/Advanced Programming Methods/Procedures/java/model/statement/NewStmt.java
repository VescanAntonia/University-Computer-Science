...
public class NewStmt implements IStmt{
    ...
    public PrgState execute(PrgState state) throws MyException{
        ...
        if((currentSymbolTable.isDefined(this.varName))){
            Value varValue=currentSymbolTable.lookUp(this.varName);
            if(varValue.getType() instanceof RefType){
                Value eval=this.expression.eval(currentSymbolTable,heap);
