...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        programListLoader.setLocation(Main.class.getResource("/com/example/toyinterpretergui/ProgramChooserController.fxml"));
        Parent programListRoot = programListLoader.load();
        Scene programListScene = new Scene(programListRoot,500,550);
        programListScene.getStylesheets().add(Objects.requireNonNull(Main.class.getResource("/com/example/toyinterpretergui/button_style.css")).toExternalForm());
        ...
        programExecutorLoader.setLocation(Main.class.getResource("/com/example/toyinterpretergui/ProgramExecutorController.fxml"));
        Parent programExecutorRoot = programExecutorLoader.load();
        Scene programExecutorScene = new Scene(programExecutorRoot, 700, 500);
        programExecutorScene.getStylesheets().add(Objects.requireNonNull(Main.class.getResource("/com/example/toyinterpretergui/button_style.css")).toExternalForm());
