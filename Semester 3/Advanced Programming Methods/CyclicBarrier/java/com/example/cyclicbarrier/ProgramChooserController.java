    ...
    private void displayProgram(ActionEvent actionEvent) throws  MyException{
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState programState = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), selectedStatement,new MyDictionary<>(), new MyHeap(),new MyCyclicBarrierTable());
                                        ...
                                        new CompStmt(
                                                ...
                                                new CompStmt(
                                                        ...
                                                        new CompStmt(
                                                                ...
                                                                new CompStmt(
                                                                        new NewBarrierStmt("cnt", new RHeap(new VarExp("v2"))),
                                                                        new CompStmt(
                                                                                new ForkStmt(
                                                                                        new CompStmt(
                                                                                                new AwaitSmt("cnt"),
