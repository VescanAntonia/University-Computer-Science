    ...
    private void displayProgram(ActionEvent actionEvent) throws  MyException{
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState programState = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), selectedStatement,new MyDictionary<>(), new MyHeap(),new MyToySemaphoreTable());
        ...
        IStmt ex12 = new CompStmt(
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(
                                        new NewSemaphoreStmt("cnt", new RHeap(new VarExp("v1")), new ValueExp(new IntValue(1))),
                                        new CompStmt(
                                                new ForkStmt(
                                                        new CompStmt(
                                                                new AcquireStmt("cnt"),
                                                ...
                                                new CompStmt(
                                                        new ForkStmt(
                                                                new CompStmt(
                                                                        ...
                                                                        new CompStmt(
                                                                                new WriteHeap("v1", new ArithExp('*',  new RHeap(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                                                                                new CompStmt(
                                                                                        new WriteHeap("v1", new ArithExp('*',  new RHeap(new VarExp("v1")), new ValueExp(new IntValue(2)))),
                                                                                        new CompStmt(
                                                                                                new PrintStmt(new RHeap(new VarExp("v1"))),
                                                                                                new ReleaseStmt("cnt")
                                                                                        )
                                                        ...
                                                        new CompStmt(
                                                                new AcquireStmt("cnt"),
                                                                new CompStmt(
                                                                        new PrintStmt(new ArithExp('-', new RHeap(new VarExp("v1")), new ValueExp(new IntValue(1)))),
                                                                        new ReleaseStmt("cnt")
                                                                )
                                                        )
                                                )
