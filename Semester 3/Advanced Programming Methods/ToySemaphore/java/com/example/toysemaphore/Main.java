...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        programListLoader.setLocation(Main.class.getResource("/com/example/toysemaphore/ProgramChooserController.fxml"));
        Parent programListRoot = programListLoader.load();
        Scene programListScene = new Scene(programListRoot,500,550);
        programListScene.getStylesheets().add(Objects.requireNonNull(Main.class.getResource("/com/example/toysemaphore/button_style.css")).toExternalForm());
        ...
        programExecutorLoader.setLocation(Main.class.getResource("/com/example/toysemaphore/ProgramExecutorController.fxml"));
        Parent programExecutorRoot = programExecutorLoader.load();
        Scene programExecutorScene = new Scene(programExecutorRoot, 700, 500);
        programExecutorScene.getStylesheets().add(Objects.requireNonNull(Main.class.getResource("/com/example/toysemaphore/button_style.css")).toExternalForm());
