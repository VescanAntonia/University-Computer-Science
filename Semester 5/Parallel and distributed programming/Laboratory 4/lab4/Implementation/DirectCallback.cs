...
{
    internal class DirectCallback
    {
        private static List<string> HOSTS;

        public static void Run(List<string> hostnames)
        {
            //initiate execution of HTTP client
            HOSTS = hostnames;
        ...
        {
            //initiate the HTTP client for each hostname
            var id = (int)idObject;
        ...
        {
            //Callback method invoked when the socket connection is established
        ...
        {
            //Callback method invoked when data is successfully sent to the server
            var state = (StateObject)ar.AsyncState;
            var clientSocket = state.socket;
            var clientID = state.clientID;
        ...
        {
            //Callback method invoked when data is received from the server
            // retrieve the details from the connection information wrapper
            var state = (StateObject)ar.AsyncState;
            var clientSocket = state.socket;
            var clientID = state.clientID;
